...
/** Mobile · List — every successful pick in league waiver order, cards expanded. */
function WeeklyWaiversList({ groups, teamLogoMap, kitIndexByEntry }) {
  const rows = useMemo(() => {
 ...
 *  • Mobile: a segmented toggle of "List" · "By team" · "Waiver summary"
