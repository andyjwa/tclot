 ...
 * stored pref — except a live GW redirects to FPL Live → Scores once status
 * resolves. The pref still drives Settings UI. Stored `'preseason'` prefs are
 * treated as missing so they don't resurrect the hub. */
